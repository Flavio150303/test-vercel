...
export default function Banner_limpieza() {
  return (
    <div className="w-full ">
      <div className="bg-[#2AA0DF] rounded-[25px]   lg:px-8 2xl:px-20 ">
        <div className=" flex flex-row  bg-no-repeat bg-cover bg-center  items-center">
          ...
          <div className="md:w-6/12  flex flex-col items-end mr-4  lg:w-8/12  ">
